...
while True:
    ...
    for box, cls in zip(results.boxes.xyxy, results.boxes.cls):
        ...
        if label in ('person'):
            ...
            cv2.line(annotated, (x1, center_y),   (x2, center_y),  (255, 100, 0), 2)
            cv2.line(annotated, (center_x, y1),   (center_x, y2),  (255, 100, 0), 2)
            cv2.circle(annotated, (center_x, center_y), 7, (0, 0, 255), -1)
